...
for file in "$SRC_DIR"/arc-*.md; do
  ...
  arc_output="<tr>
    <td><a href=\"/arc-standards/arc-$arc_href/\" style='display: block; text-decoration: none; color: inherit;'>$arc</a></td>
    <td><a href=\"/arc-standards/arc-$arc_href/\" style='display: block; text-decoration: none; color: inherit;'>$title</a></td>
    <td><a href=\"/arc-standards/arc-$arc_href/\" style='display: block; text-decoration: none; color: inherit;'>$description</a></td>
  </tr>"
