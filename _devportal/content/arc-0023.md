...
created: 2023-01-11
adoption-summary: adoption/arc-0023.yaml
---
## Abstract
...
* example of the [application.py](https://raw.githubusercontent.com/algorandfoundation/ARCs/main/assets/arc-0023/application_information/application.py).
* example of the contract metadata that follows [ARC-4](/arc-standards/arc-0004) [contract.json](https://raw.githubusercontent.com/algorandfoundation/ARCs/main/assets/arc-0023/application_information/contract.json).

Files are accessible through the following IPFS command:
