...
created: 2022-12-01
adoption-summary: adoption/arc-0032.yaml
requires:
  - 4
  - 21
---
...
```ts
type AppSpec = {
  // embedded contract fields, see ARC-4 for more
  ...
  // supplemental information for calling ARC-4 ABI methods
  hints: HintsSpec;
...
Contains supplemental information about [ARC-4](/arc-standards/arc-0004) ABI methods, each record represents a single method in the [ARC-4](/arc-standards/arc-0004) contract. The record key should be the corresponding ABI signature.

NOTE: Ideally this information would be part of the [ARC-4](/arc-standards/arc-0004) ABI specification.
...
NOTE: This property is made obsolete by [ARC-22](/arc-standards/arc-0022) but is included as it is currently
...
A full JSON schema for application.json is [available](https://raw.githubusercontent.com/algorandfoundation/ARCs/main/assets/arc-0032/application.schema.json).
