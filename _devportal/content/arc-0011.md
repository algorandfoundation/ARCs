...
category: Interface
created: 2021-08-09
adoption-summary: adoption/arc-0011.yaml
---
## Abstract

A common convention for DApps to discover Algorand wallets in browser code: `window.algorand`.
A property `algorand` attached to the `window` browser object, with all the features defined in [ARC-10](/arc-standards/arc-0010#specification).
...
With the specifications and semantics for each function as stated in [ARC-10](/arc-standards/arc-0010#specification).
