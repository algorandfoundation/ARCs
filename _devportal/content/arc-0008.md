...
category: Interface
created: 2021-08-09
adoption-summary: adoption/arc-0008.yaml
---
## Abstract

A function `signAndPostTxns`, which accepts an array of `WalletTransaction`s, and posts them to the network.

Accepts the inputs to [ARC-1](/arc-standards/arc-0001#interface-signtxnsfunction)'s / [ARC-5](/arc-standards/arc-0005#interface-signtxnsfunction)'s `signTxns`, and produces the output of [ARC-7](/arc-standards/arc-0007#interface-posttxnsfunction)'s `postTxns`.
...
* `WalletTransaction` is as specified by [ARC-5](/arc-standards/arc-0005#interface-wallettransaction).
* `PostTxnsResult` is as specified by [ARC-7](/arc-standards/arc-0007#interface-posttxnsfunction).

Errors are handled exactly as specified by [ARC-1](/arc-standards/arc-0001#error-standards) and [ARC-7](/arc-standards/arc-0007#error-standard)
