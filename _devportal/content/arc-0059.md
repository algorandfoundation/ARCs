...
author:
  - Kadir Can Çetin (@kadircancetin)
  - Yigit Guler (@yigitguler)
  - Joe Polny (@joe-p)
  - Kevin Wellenzohn (@k13n)
...
sub-category: Wallet
created: 2024-03-08
adoption-summary: adoption/arc-0059.yaml
requires:
  - 4
---
## Abstract
...
[Test cases](https://raw.githubusercontent.com/algorandfoundation/ARCs/main/assets/arc-0059/__test__) for the JavaScript client and the [ARC-59](/arc-standards/arc-0059) smart contract implementation are provided.

## Reference Implementation

A project with the [full reference implementation](https://github.com/algorandfoundation/ARCs/tree/main/assets/arc-0059), including the smart contract and JavaScript library (used for testing), is provided.
