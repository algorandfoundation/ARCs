...
sub-category: Wallet
created: 2021-08-09
adoption-summary: adoption/arc-0005.yaml
---
## Abstract
...
`signTxns` **SHOULD** follow the error standard specified in [ARC-1](/arc-standards/arc-0001#error-standards).

### UI requirements

Wallets satisfying this ARC but not [ARC-1](/arc-standards/arc-0001) **MUST** clearly display a warning to the user that they **MUST** not be used with real funds on MainNet.

## Rationale

This simplified version of ARC-1 exists for two main reasons:

1. To outline the minimum amount of functionality needed in order to be useful.
2. To serve as a stepping stone towards full ARC-1 compatibility.
