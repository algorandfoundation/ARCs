...
implementation-url: https://github.com/algorandfoundation/arc62
implementation-maintainer:
  - "@cusma"
adoption-summary: adoption/arc-0062.yaml
requires:
  - 2
  - 4
  - 22
...
[ARC-19](/arc-standards/arc-0019), etc.) as metadata declared in the ASA URL field,
...
An Algorand-Python example is [available](https://github.com/algorandfoundation/ARCs/tree/main/assets/arc-0062).
...
> global storage, box storage, etc. See [Example 2](/arc-standards/arc-0062#example-2) for
> reference.
