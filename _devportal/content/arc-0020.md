...
implementation-url: https://github.com/algorandfoundation/arc20
implementation-maintainer:
  - "@cusma"
adoption-summary: adoption/arc-0020.yaml
requires:
  - 4
  - 22
extended-by:
...
([ARC-3](/arc-standards/arc-0003), [ARC-69](/arc-standards/arc-0069)), then it MUST include a
...
- Developer adoption, by reusing the familiar ASA transaction reference in the
...
Assets implementing [ARC-18](/arc-standards/arc-0018) MAY also be compatible with this ARC
...
A reference implementation is [available](https://github.com/algorandfoundation/ARCs/tree/main/assets/arc-0020).
