...
- All params from the base [ARC-26](/standards/arcs/arc-0026) standard, are supported and usable if fit the NoOp application call context (e.g. note)
...
- type: fixed to "appl". Used to disambiguate the transaction type from the base [ARC-26](/standards/arcs/arc-0026) standard and other possible extensions
