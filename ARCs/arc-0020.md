...
interpreted as described in <a href="https://datatracker.ietf.org/doc/html/rfc2119">RFC 2119</a>.
...
reference <https://dev.algorand.co/concepts/assets/overview/#asset-parameters>
...
>   use/retrieval.
>
> The business logic associated with the update of the other parameters is left to
...
It is RECOMMENDED to the [ARC-89](./arc-0089.md) ASA Metadata Registry to declare
...
Existing ASA willing to conform to this ARC MUST specify the controlling Smart Contract
ID as [ARC-2](./arc-0002.md) `AssetConfig` transaction note field, as follows:

- The `<arc-number>` MUST be equal to `20`;
- The RECOMMENDED `<data-format>` are <a href="https://msgpack.org/">MsgPack</a>
(`m`) or <a href="https://www.json.org/json-en.html">JSON</a> (`j`);
- The `<data>` MUST specify `application-id` equal to the controlling Smart Contract
ID.
...
A [reference implementation](https://github.com/algorandfoundation/arc20) is maintained
