...
>   - `asset_name` and `unit_name` MAY be set to `SMART-ASA` and `S-ASA`, to
...
Calling `circulating_supply` returns the circulating supply of a Smart ASA.

> Upon a call to `circulating_supply`, a reference implementation SHOULD:
>
