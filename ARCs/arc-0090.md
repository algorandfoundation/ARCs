...
> 
> Parameters containing text or binary data (e.g. note) MUST be encoded according to [RFC 3986](https://www.rfc-editor.org/rfc/rfc3986).
...
3. Optionally fetch or reference the corresponding ARC specification documents,  
   ...
   - [ARC-16](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0016.md)
