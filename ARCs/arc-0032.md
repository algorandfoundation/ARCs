...
Contains supplemental information about [ARC-4](./arc-0004.md) ABI methods, each record represents a single method in the [ARC-4](./arc-0004.md) contract. The record key should be the corresponding ABI signature.

NOTE: Ideally this information would be part of the [ARC-4](./arc-0004.md) ABI specification.
...
NOTE: This property is made obsolete by [ARC-22](./arc-0022.md) but is included as it is currently
...
A full JSON schema for application.json is [available](../assets/arc-0032/application.schema.json).
