...
> The tutorial can be found here: <a href="">xGov proposal submission Tutorial</a>.
...
### Grants payment
Once grants has been approved, the Algorand Foundation team will handle the fund transfer process and contracts associated with each proposal.
