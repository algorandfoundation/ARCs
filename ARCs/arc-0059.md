...
[Test cases](../assets/arc-0059/__test__) for the JavaScript client and the [ARC-59](./arc-0059.md) smart contract implementation are provided.

## Reference Implementation

A project with the [full reference implementation](../assets/arc-0059), including the smart contract and JavaScript library (used for testing), is provided.
