...
Before writing a formal ARC, you should vet your idea. Ask the Algorand community first if an idea is original to avoid wasting time on something that will be rejected based on prior research. We recommend opening a discussion thread on [the Algorand forum](https://forum.algorand.org) to do this, but you can also use [Algorand Discord #arcs](https://discord.gg/algorand) chat room.
