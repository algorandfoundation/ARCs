...
author: MG (@emg110), @GoPlausible, @VoiNetwork, @GoraNetwork, @DaffiDigital
status: Draft
...
The [ARC113] verifiable credentials trust model, based on Algorand technology features, is as follows:
...
// TODO: Examples of verifiable credentials and presentations in [JSON-LD] format will be provided, demonstrating the application of [ARC113] in real-world scenarios.
