...
Building off of the previous ARCs relating to; wallet transaction signing ([ARC-0005](./arc-0005.md#specification)), wallet address discovery ([ARC-0006](./arc-0006.md#specification)), wallet transaction network posting ([ARC-0007](./arc-0007.md#specification)) and wallet transaction signing & posting ([ARC-0008](./arc-0008.md#specification)), this proposal aims to extend and comprehensively outline a common message schema between providers and dApps.

<sup>[Back to top ^][top]</sup>

## Motivation

The aim of this proposal is to define an ARC that amalgamates the previous ARCs relating to provider-dApp communication, and to extend these methods to encompass new functionality such as "disabling" a dApp on a provider.
