...
author:
  - Kieran O'Neill (@kieranroneill)
status: Final
type: Standards Track
category: Interface
sub-category: Wallet
created: 2023-12-24
adoption-summary: adoption/arc-0027.yaml
---

## Abstract

Building off of the work of the previous ARCs relating to; provider transaction signing ([ARC-5](arc-0005.md)), provider address discovery ([ARC-6](arc-0006.md)), provider transaction network posting ([ARC-7](arc-0007.md)) and provider transaction signing & posting ([ARC-8](arc-0008.md)), this proposal aims to comprehensively outline a common message schema between clients and providers.
...
|------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|
| `disable`                    | Removes access for the clients on the provider. What this looks like is the prerogative of the provider.                                                                                                                                                                                                                                                                | [example](#disable-example)                    |
| `discover`                   | Sent by a client to discover the available provider(s). If the `params.providerId` property is supplied, only the provider with the matching ID **SHOULD** respond. This method is usually called before other methods as it allows the client to identify provider(s), the networks the provider(s) supports and the methods the provider(s) supports on each network. | [example](#discover-example)                   |
| `enable`                     | Requests that a provider allow a client access to the providers' accounts. The response **MUST** return a user-curated list of available addresses. Providers **SHOULD** create a "session" for the requesting client, what this should look like is the prerogative of the provider(s) and is beyond the scope of this proposal.                                       | [example](#enable-example)                     |
| `post_transactions`          | Sends a list of signed transactions to be posted to the network by the provider.                                                                                                                                                                                                                                                                                        | [example](#post-transactions-example)          |
| `sign_and_post_transactions` | Sends a list of signed transactions to be posted to the network by the provider.                                                                                                                                                                                                                                                                                        | [example](#sign-and-post-transactions-example) |
| `sign_message`               | Sends a UTF-8 encoded message to be signed by the provider.                                                                                                                                                                                                                                                                                                             | [example](#sign-message-example)               |
| `sign_transactions`          | Sends a list of transactions to be signed by the provider.                                                                                                                                                                                                                                                                                                              | [example](#sign-transactions-example)          |
