...
The aim of this proposal is to define an ARC that amalgamates the previous ARCs relating to provider-dApp communication, and to extend these method to encompass new functionality such as "disabling" a dApp with a provider.
...
|-------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|
| `disable`                     | Removes                                                                                                                                                                                                                                                                                                                                                             | [here](#disable-example)                    |
...
| `enable`                      | Requests that providers allow a dApp access to the provider's accounts. The response **MUST** return a user-curated list of available addresses. Providers **SHOULD** create a "session" for the requesting dApp, what this should look like is the prerogative of a provider and is beyond the scope of this proposal.                                             | [here](#enable-example)                     |
