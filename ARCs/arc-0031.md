...
The ARC-0031 authentication mechanism **MUST** proceeds as follows:

1. The User connects with *PKa* to the Waller and initiates an authentication to the Verifier;
