...
A property `algorand` attached to the `window` browser object, with all the features defined in [ARC-10](./arc-0010.md#specification).
...
With the specifications and semantics for each function as stated in [ARC-10](./arc-0010.md#specification).
