...
```json
{
    ...
    "methods":[
        ...
        {
            "name":"transfer",
            "desc":"Transfers an Asset from one account to another and enforces royalty payments. This method is used for Algo payments.",
            "args":[
                {"name":"royalty_asset", "type":"asset"}, 
        ...
        {
            "name":"transfer",
            "desc":"Transfers an Asset from one account to another and enforces royalty payments. This method is used for ASA payments.",
            "args":[
                {"name":"royalty_asset", "type":"asset"}, 
                {"name":"owner_acct", "type":"account"},
                {"name":"buyer_acct", "type":"account"},
