...
The fields that should be specified are the `application-id` as described in [ARC24](./arc-0024.md) and `rekey-checked` which describes whether or not this application implements the rekey checks during transfers. 
