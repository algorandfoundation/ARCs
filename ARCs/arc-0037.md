...
Every vote will be a different ID, but, search for all apps created by the account that is used and look at the global state to see if is_bootstrapped is 1. 
