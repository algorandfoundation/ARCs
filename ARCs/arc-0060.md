...
- The `data` object is a string representing the array of bytes being signed. If the schema also provides additional structured objects, then it **SHOULD** indicate the SHA256 of all the canonicalized `additionalProperties`.
