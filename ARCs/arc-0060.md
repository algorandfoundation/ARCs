...
discussions-to:  https://github.com/algorandfoundation/ARCs/pull/284
status: Draft
...
- the length of `arbData` and `metadata` **MUST** be equal, otherwise the wallet **MUST** reject the call.
