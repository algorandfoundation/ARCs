...
author: MG (@emg110), VoiNetwork (@VoiNetwork), GoraNetwork (@GoraNetwork), DaffiDigital (@DaffiDigital), GoPlausible (@GoPlausible)
status: Draft
...
ARC-13 as well as ARC-113, heavily depend and rely on [ARC-52](./arc-0052.md) line of work and reference implementation to proceed on verifiers and keys!
