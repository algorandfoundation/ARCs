...
* `error.code`:
  ...
  - **MAY** be [4004 `NetworkNotSupoortedError`](#4004-networknotsupportederror) if the `genesisHash` provided in the request is not supported by the provider
* `reference`:
...
```json
{
  "title": "Post Transactions Payload",
  "type": "object",
  "properties": {
    "error": {
      "type": "object",
...
* `error.code`:
  ...
  - **MAY** be [4002 `MethodTimedOutError`](#4002-methodtimedouterror) if the request timed out
  - **MAY** be [4003 `MethodNotSupportedError`](#4003-methodnotsupportederror) if the method is not supported by the provider
  - **MAY** be [4004 `NetworkNotSupoortedError`](#4004-networknotsupportederror) if the `genesisHash` provided in the transactions to be signed is not supported by the provider
...
```json
{
  "title": "Sign Transactions Request",
  "type": "object",
  "properties": {
    "id": {
      "type": "string",
...
```json
{
  "title": "Sign Transactions Payload",
  "type": "object",
  "properties": {
    "error": {
      "type": "object",
