...
[ARC13] proposes a dynamic method to generate deterministic DIDs for existing Algorand elements on both MAINNET and TESTNET!
Within [ARC13] specification only composite new elements are in need of registry and therefore occupying some storage space!
