---
arc: 16
title: Convention for declaring traits of an ASA's
description: This is a convention for declaring traits in an ASA's (NFT) metadata.
author: Keegan Thompson (@keeganthomp)
discussions-to: https://github.com/algorandfoundation/ARCs/issues/62
status: Last Call
last-call-deadline: 2022-09-22
...
The goal is to establish a standard for how traits are declared inside a non-fungible ASA's (NFT) metadata, for example as specified in ([ARC-3](./arc-0003.md)) or ([ARC-69](./arc-0069.md)).
