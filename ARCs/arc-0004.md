...
transaction arguments were completely absent.  The application call
would contain the method selector in ApplicationArgs[0], the first
(string) argument in ApplicationArgs[1], and the third (uint32)
argument in ApplicationArgs[2].
