---
arc: <to be assigned>
title: NFT Indexer Standard
description: Standard REST API for reading data about ARC-72 NFTs.
...
## Motivation
While most data about ARC-72 NFTs is available on-chain, reading and analyzing on-chain logs to get a complete and current picture about NFT ownership and history is slow and impractical for many uses.
