...
## Resources
### Artists
- [Add metadata to your existing NFTs](https://github.com/algokittens/arc69/blob/master/pre-existing-NFTs.md)
### Developers
- [Fetch and parse metadata for NFTs with JavaScript](https://github.com/RandGallery/arc69js)
