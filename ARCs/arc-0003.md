...
description: Parameters Conventions for ASAs for fungible tokens and non-fungible tokens (NFTs).
author:
...
adoption-summary: adoption/arc-0003.yaml
extended-by:
  - 89
---
...
```json
{
    ...
    "properties": {
        ...
        "background_color": {
            "type": "string",
            "description": "Background color do display the asset. MUST be a six-character hexadecimal without a prepended #."
        },
        "external_url": {
            "type": "string",
...
Concretely, every URI field `xxx` is allowed to have an optional associated field  `xxx_integrity` that specifies the digest of the file pointed by the URI.
