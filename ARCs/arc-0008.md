...
Accepts the inputs to [ARC-1](./arc-0001.md#interface-signtxnsfunction)'s / [ARC-5](./arc-0005.md#interface-signtxnsfunction)'s `signTxns`, and produces the output of [ARC-7](./arc-0007.md#interface-posttxnsfunction)'s `postTxns`.
...
* `WalletTransaction` is as specified by [ARC-5](./arc-0005.md#interface-wallettransaction).
* `PostTxnsResult` is as specified by [ARC-7](./arc-0007.md#interface-posttxnsfunction).

Errors are handled exactly as specified by [ARC-1](./arc-0001.md#error-standards) and [ARC-7](./arc-0007.md#error-standard)
