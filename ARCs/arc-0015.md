...
adoption-summary: adoption/arc-0015.yaml
requires:
  - 4
---
...
This ARC provides real-time encrypted A2P (application-to-person) notifications without having to provide user email addresses and without any vendor lock-in.
