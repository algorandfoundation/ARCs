...
* example of the [application.py](../assets/arc-0023/application_information/application.py).
* example of the contract metadata that follows [ARC-4](arc-0004.md) [contract.json](../assets/arc-0023/application_information/contract.json).
