...
### Duty of an xGov
As an xGov, you **MUST** actively participate in the governance process by using all available votes each time a voting period occurs.  Failure to do so will result in disqualification. 
