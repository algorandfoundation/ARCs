...
|---------------------------------------------------------------------------|-----------------------|
| `Arc89MetadataCreated(uint64,uint64,uint64,byte[32],byte,bool,bool,bool)` | `1d840292`            |
| `Arc89MetadataUpdated(uint64,uint64,uint64,byte[32],bool)`                | `6fc7c1f5`            |
| `Arc89MetadataDeleted(uint64,uint64,uint64)`                              | `bc3f20d1`            |
| `Arc89MetadataUpdatedFlags(uint64,uint64,uint64,byte,byte,byte[32])`      | `2d82b2e8`            |
