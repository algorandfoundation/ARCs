  ...
  "methods": [
    {
      ...
      "args": [
        ...
        { "type": "byte", "name": "metadata_header", "desc": "The Asset Metadata Header. WARNING: if the MSB is True the Asset Metadata is IMMUTABLE" },
    ...
    },
    {
      ...
      "args": [
        ...
        { "type": "bool", "name": "supported", "desc": "The ASA supports ARC-20 if True, otherwise it does not" }
      ],
    ...
    },
    {
      ...
      "args": [
        ...
        { "type": "bool", "name": "supported", "desc": "The ASA supports ARC-62 if True, otherwise it does not" }
      ],
...
- The provided `metadata_header` (`byte`) size **MUST** be `1`.
...
The [Metadata Header](#metadata-header) **MUST** be set to provided `metadata_header`
(`byte`) value.
...
be set to the provided `supported` (`bool`) value.
