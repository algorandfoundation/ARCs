...
Hash components **MUST NOT** be reinterpret as a signed integer, bitset string, or
...
> specifically:
> 
> 1. If the Metadata size at creation time will be less than or equal to `MAX_SHORT_METADATA_SIZE`,
...
### [ARC-69](./arc-0069.md) Migration

Deprecated [ARC-69](./arc-0069.md) metadata previously stored in transaction notes
**SHOULD** be mirrored into [ARC-89](./arc-0089.md) metadata on the ASA Metadata
Registry.

Clients **MAY** surface both during a deprecation window.

### [ARC-19](./arc-0019.md) Mutual Exclusion

[ARC-19](./arc-0019.md) metadata stored on IPFS **SHOULD NOT** be mirrored into [ARC-89](./arc-0089.md)
metadata on the ASA Metadata Registry.

Clients **SHOULD** consider [ARC-19](./arc-0019.md) and [ARC-89](./arc-0089.md) metadata
as _mutually exclusive_.
...
```json
{
  ...
  "methods": [
    ...
    },
    {
      ...
      "desc": "Return the Asset Metadata Hash for an ASA (if set), otherwise compute the ARC-89 Metadata Hash",
      "args": [
