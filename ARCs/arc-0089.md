...
```json
{
  ...
  "methods": [
    ...
    },
    {
      ...
      "readonly": true,
      "args": [],
      "returns": { "type": "(uint16,uint16,uint16,uint16,uint64,uint64)", "desc": "The first value is the HEADER_SIZE, the second value is the MAX_METADATA_SIZE, the third value is the SHORT_METADATA_SIZE, the fourth value is the PAGE_SIZE, the fifth value is the FLAT_MBR, the sixth value is the BYTE_MBR" }
    },
    {
