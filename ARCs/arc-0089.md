      ...
      "events": [
        {
          ...
          "args": [
            ...
            { "type": "uint64", "name": "timestamp", "desc": "Timestamp of the Asset Metadata delete" }
          ]
        }
      ],
      "returns": { "type": "(uint8,uint64)", "desc": "MBR Delta: sign enum, and amount (microALGO)" }
...
To provide an extra payload to concatenate to Asset Metadata creation or replace
for an ASA:
