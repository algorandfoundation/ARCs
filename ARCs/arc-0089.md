...
The **RECOMMENDED** creation process for an [ARC-89](./arc-0089.md) _native_ ASA:
...
The **RECOMMENDED** creation process for an [ARC-89](./arc-0089.md) _native_ ASA with [ARC-3 compliant](#arc-3-compliant)
Metadata is:
      ...
      "events": [
        {
          ...
          "args": [
            { "type": "uint64", "name": "asset_id", "desc": "The Asset ID of the created or updated Asset Metadata" },
            { "type": "uint64", "name": "new_app_id", "desc": "The Application ID of the new ASA Metadata Registry version" },
