...
discussions-to: https://github.com/algorandfoundation/ARCs/pull/356
status: Draft
...
_Asset Metadata URI_ are a simple and efficient way to provide the _mutable_ and
_immutable_ Asset Metadata to the clients directly through the <a href="https://dev.algorand.co/reference/rest-api/algod/">Algod API</a>,
