...
```json
{
  ...
  "methods": [
    ...
    },
    {
      ...
      "readonly": true,
      "args": [
        { "type": "uint64", "name": "asset_id", "desc": "The Asset ID to check ARC-3 setting for" }
      ],
      "returns": { "type": "bool", "desc": "The ASA is an ARC-3 ASA" }
    },
    {
      "name": "arc89_is_arc89_asa",
      "desc": "Return True if the ASA is a native ARC-89 ASA, False otherwise",
      "readonly": true,
      "args": [
        { "type": "uint64", "name": "asset_id", "desc": "The Asset ID to check the ARC-89 setting for" }
      ],
...
The method **MUST** return the value of the [ARC-3 Compliant](#arc-3-compliant) flag.
