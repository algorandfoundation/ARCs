...
The [Native ARC-89 ASA Flag](#arc-89-native-asa) **SHOULD** be set to `True`.
...
- The [ARC-3 Compliant Flag](#arc-3-compliant) **SHOULD** be set to `True`.
...
```json
{
  ...
  "methods": [
    ...
    },
    {
      ...
      "readonly": true,
      "args": [],
      "returns": { "type": "(uint16,uint16,uint16,uint16,uint16,uint16,uint64,uint64)", "desc": "The first value is the HEADER_SIZE, the second value is the MAX_METADATA_SIZE, the third value is the SHORT_METADATA_SIZE, the fourth value is the PAGE_SIZE, the fifth value is the FIRST_PAYLOAD_MAX_SIZE, the sixth is the EXTRA_PAYLOAD_MAX_SIZE, the seventh FLAT_MBR, the eighth value is the BYTE_MBR" }
    },
    {
    ...
    },
    {
       ...
       "returns": { "type": "string", "desc": "The object value from valid UTF‑8 JSON Metadata" }
    }
  ]
}
```
...
- The seventh value is the `FLAT_MBR` (`uint64`),

- The eighth value is the `BYTE_MBR` (`uint64`).
