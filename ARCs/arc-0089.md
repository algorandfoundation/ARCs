  ...
  "methods": [
    ...
    },
    {
      ...
      "args": [
        ...
        { "type": "uint32", "name": "flat_mbr", "desc": "Box flat MBR component (microALGO) - Optional: if 0 the default value is used" },
        { "type": "uint32", "name": "byte_mbr", "desc": "Box per-byte MBR component (microALGO) - Optional: if 0 the default value is used" }
      ],
      "returns": { "type": "(uint8,uint64)", "desc": "MBR Delta: sing (null (0), positive (1), or negative (255)) and amount (microALGO)" }
    }
  ]
...
The `flat_mbr` and `byte_mbr` are **OPTIONAL** and **SHOULD** be set to `0`, unless
the Box MBR cost structure is changed in future version of the Algorand protocol.
