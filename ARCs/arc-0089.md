...
implementation-url: https://github.com/algorandfoundation/arc89
...
|  `2`  | [ARC-54](./arc-0054.md) Burnable ASA            | `False` | Any                  |
|  `3`  | Custom, should be reserved for future ARCs      | `False` | Any                  |
|  `4`  | Custom, should be reserved for future ARCs      | `False` | Any                  |
|  `5`  | Custom, should be reserved for future ARCs      | `False` | Any                  |
|  `6`  | Custom, should be reserved for future ARCs      | `False` | Any                  |
...
The Metadata **MAY** be declared as [ARC-3](./arc-0003.md) _compliant_ on creation,
...
The ASA **MAY** be declared as a _burnable_ [ARC-54](./arc-0054.md) ASA on creation
...
and **MAY** declare the [ARC-90 compliance fragment](./arc-0090.md#compliance-fragment)
...
defined by [ARC-90](./arc-0090.md#compliance-fragment).

If the [ARC-3](./arc-0003.md) compliance fragment is used, it **MUST** be the only
fragment as defined by [ARC-90](./arc-0090.md#compliance-fragment) (i.e., `#arc3`
...
ASA metadata on the registry can be read and written programmatically on-chain, making
...
- The first value is the `ASSET_METADATA_BOX_KEY_SIZE` (`uint8`),
...
- The ninth value is the `FLAT_MBR` (`uint64`),
...
clients **SHOULD** reuse the `arc89_get_metadata_pagination` method and restart
