...
|  `2`  | Reserved for future ARCs                             | `False` | Two-ways, any time   |
|  `3`  | Reserved for future ARCs                             | `False` | Two-ways, any time   |
...
|  `6`  | Reserved for future ARCs                             | `False` | One-way, any time    |
...
which consumes an extra `pay` transaction in the Group;
