  ...
  "methods": [
    {
      ...
      "args": [
        ...
        { "type": "uint16", "name": "metadata_size", "desc": "The Asset Metadata byte size to be created" },
...
If the provided `metadata_size ≤ MAX_SHORT_METADATA_SIZE`, the [Short Metadata Identifier](#short-metadata)
**MUST** be set to `True`.
...
> Interleaving on different Group levels (top-lever / inner) are **not supported**.
> 
