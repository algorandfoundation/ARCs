...
If the getter supports *on-chain* calls (i.e. "Contract-2-Contract") and the implementation
uses external resources, the Circulating Supply App **SHOULD** conform to [ARC-56](./arc-0056.md).
