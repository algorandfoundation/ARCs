...
or declare its metadata migration to the ASA Metadata Registry following the [ARC-89](./arc-0089.md)
...
The trusted deployments of ASA Circulating Supply App are:
