...
Note 2: In current status this ARC assumes a basic trust to be existing between Issuer and Receiver and that Issuer is trusted by Receiver.

Note 3: Heavy discussions and development is ongoing to address these 2 noted items. WIP. Proposed active solution for item 1:
