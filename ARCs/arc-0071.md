...
Note 2: In current status this ARC assumes a basic trust to be existing between Issuer and Receiver and that Issuer is trusted by Receiver to play fair.
